========================================================================
    ПРИЛОЖЕНИЕ : Обзор проекта HideInformationInImage
========================================================================

Это приложение HideInformationInImage создано автоматически с помощью мастера 
приложений.  

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения HideInformationInImage.

HideInformationInImage.vcxproj
...
HideInformationInImage.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем HideInformationInImage.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
